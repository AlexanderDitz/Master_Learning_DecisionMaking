...
q_values_per_trial_path = 'data/synthetic_data/dezfouli2019_generated_behavior_spice2_l2_0_001.csv'
...
plt.savefig('results/vector_field_spice.png', dpi=300, bbox_inches="tight")
plt.show()