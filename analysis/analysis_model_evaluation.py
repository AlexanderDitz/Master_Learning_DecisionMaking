...
# path_model_rnn = 'params/sugawara2021/params_sugawara2021.pkl'
# path_model_benchmark = 'params/sugawara2021/params_sugawara2021_MODEL.nc'
...
avg_log_likelihood = scores[:, :1] / (len(dataset)-failed_attempts) / probs.shape[0]#np.prod(probs.shape)
...
# scores_normalized = np.concatenate((scores_normalized, n_parameters.reshape(-1, 1)), axis=1)
...
#     index=['Baseline', 'Benchmark', 'RNN', 'SPICE'],
#     columns = ('Likelihood', 'BIC', 'AIC', 'n_parameters'),
#     )
# print(df)
