...
SindyConfig_eckstein2022_trials = {
  ...
  'control_parameters': ['c_action', 'c_reward_chosen', 'c_value_reward', 'c_value_choice', 'c_value_trial'],
  
  # library setup: 
  # which terms are allowed as control inputs in each SINDy model
  # key is the SINDy model name, value is a list of allowed control inputs from the list of control signals 
  'library_setup': {
      'x_learning_rate_reward': ['c_reward_chosen', 'c_value_reward', 'c_value_choice', 'c_value_trial'],
      'x_value_reward_not_chosen': ['c_reward_chosen', 'c_value_choice', 'c_value_trial'],
      'x_value_choice_chosen': ['c_value_reward', 'c_value_trial'],
      'x_value_choice_not_chosen': ['c_value_reward', 'c_value_trial'],
  },
